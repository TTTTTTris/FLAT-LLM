...
class CustomLlamaFlashAttention2(LlamaFlashAttention2):
    ...
    def forward(
        ...
        **kwargs,
        ...
        attn_output = attn_output.reshape(bsz, q_len, self.v_proj.weight.shape[0] * self.num_key_value_groups).contiguous()
        attn_output = self.o_proj(attn_output)
...
class CustomLlamaDecoderLayer(LlamaDecoderLayer):
    ...
    def __init__(self, config: LlamaConfig, layer_idx: int):
        ...
        self.self_attn = LLAMA_ATTENTION_CLASSES[config._attn_implementation](config=config, layer_idx=layer_idx).to(self.input_layernorm.weight.device)
